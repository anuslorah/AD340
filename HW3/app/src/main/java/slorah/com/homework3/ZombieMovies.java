...
public class ZombieMovies {
    ...
    public ZombieMovies(String title) {
        this.title = title;
    }
    ...
    public static class Builder {
        ...
        public ZombieMovies build() {
            return movie;
        }
    }


    public static ZombieMovies[] initMovies() {
        ArrayList<ZombieMovies> movieArray = new ArrayList<>();

        movieArray.add(new ZombieMovies.Builder()
                .title("Night of the Comet")
                .year(1984)
                .director("")
                .imageLink("http://collider.com/wp-content/uploads/2016/10/night-of-comet.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/07/dead-snow.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://cdn.collider.com/wp-content/uploads/2017/10/cemetary-man.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2015/08/28-weeks-later.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://cdn.collider.com/wp-content/uploads/2017/10/night-of-the-creeps.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/Zombieland-movie-image-Woody-Harrelson-Jesse-Eisenberg-1.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/rose_mcgowan_and_marley_shelton_star_in_robert_rodriquez_s_planet_terror_grindhouse_s.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/12/train-to-busan-movie-image.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://cdn.collider.com/wp-content/uploads/2017/10/the-beyond.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://cdn.collider.com/wp-content/uploads/2017/10/day-of-the-dead.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .year(1988)
                .director("Wes Craven")
                .imageLink("http://cdn.collider.com/wp-content/uploads/2017/10/the-serpent-and-the-rainbow.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/09/re-animator.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .year(1971)
                .director("Lucio Fulci")
                .imageLink("http://collider.com/wp-content/uploads/2016/10/zombi-2.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/10/dawn-of-the-dead.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/return_of_the_living_dead_movie_image_01.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/04/dead-alive.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2016/10/28-days-later.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .year(1968)
                .director("George Romero")
                .imageLink("http://collider.com/wp-content/uploads/2015/10/night-of-the-living-dead.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .imageLink("http://collider.com/wp-content/uploads/2014/10/shaun-of-the-dead-image.jpg")
        ...
        movieArray.add(new ZombieMovies.Builder()
                ...
                .year(1978)
                .director("George Romero")
                .imageLink("http://collider.com/wp-content/uploads/2015/08/dawn-of-the-dead-romero.jpg")
        ...
        ZombieMovies[] movie = new ZombieMovies[movieArray.size()];
